...
contract Aurei is IAurei {
	...
	bytes32 private constant _TYPE_HASH = 0x8b73c3c69bb8fe3d512ecc4cf759cc79239f7b179b0ffacaa9a75d522b39400f; // keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)");
	...
	// --- Functions for intra-liquidity calls ---
	...
	(
		...
		override
	{
		require(deadline >= block.timestamp, 'AUR: expired deadline');
		...
		require(recoveredAddress == owner, 'AUR: invalid signature');
	...
	function _requireValidRecipient(address _recipient) internal view {
		...
		require(
			...
			"AUR: Cannot transfer tokens directly to the StabilityPool, VaultManager or BorrowerOps"
		);
	}
