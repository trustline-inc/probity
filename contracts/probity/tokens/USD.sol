...
contract USD is IUSD, Stateful {
    ...
    function mint(address account, uint256 amount) external override onlyBy("gov") {
    ...
    function burn(address account, uint256 amount) external override onlyBy("gov") {
        assert(account != address(0));
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "USD/permit: EXPIRED");
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, "USD/permit: INVALID_SIGNATURE");
    ...
    function _requireValidRecipient(address _recipient) internal view {
        require(
            ...
            "USD/_requireValidRecipient: Cannot transfer tokens directly to the USD token contract or the zero address"
        );
    }
}
